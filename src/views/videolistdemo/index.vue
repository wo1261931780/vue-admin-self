        ...
        <el-form :inline="true">
            <el-col :span="5">
                <el-form-item label="作者：">
                    <el-select v-model="queryinput.author" filterable @change="authorquery" clearable
                               placeholder="请选择作者">
                        <!--    2021年8月27日16:32:05                    下拉框应设置为多选，但是会导致查询条件为一个数组，需要在query中修改-->
                        <el-option
            ...
            <el-col :span="5">
                <el-form-item label="剪辑：">
                    <el-select v-model="queryinput.videocreator" filterable clearable
            ...
            <el-col :span="5">
                <el-form-item label="主题：">
                    <el-select v-model="queryinput.theme" filterable clearable @change="themequery"
                               placeholder="请选择主题">
                        <el-option
            ...
            <el-col :span="9">
                <el-form-item label="状态：">
                    <el-select v-model="queryinput.status" filterable clearable @change="statusquery"
                               placeholder="请选择状态">
                        <el-option
            ...
            <el-table
                ...
                <el-table-column
                    ...
                    <template slot-scope="scope">
                        ...
                        <br/>
                        <el-button size="mini" @click="dialogVisible9 = true">配音修改</el-button>
                        <br>
                ...
                >
                    ...
                    <template >
                        ...
                        <el-button size="mini" @click="dialogVisible12 = true">分配剪辑</el-button>
                    </template>
                </el-table-column>
                <el-table-column
                    align="center"
                ...
                <el-table-column
                    ...
                    <el-button
                        ...
                        size="mini"
                        type="primary"
                        @click="dialogVisible2 = true">二次审核
                    </el-button>
                    <br/>
                    <el-button
                        plain
...
<el-form-item label="选择文件：">
  ...
  <div slot="tip" class="el-upload__tip">文件不支持多选，只能上传jpg/png文件，且不超过500kb</div>
    <div slot="tip" class="el-upload__tip">配音文件只存在一个，这里需要接口中设置覆盖</div>
</el-upload>
        </span>
                <span slot="footer" class="dialog-footer">
    ...
    methods: {
        ...
        reviewsprogressquery() {
            let con = {
                ...
                columns: 'id,obj_id,check_time,check_user,opinion,check_result,current_status,machine_report'
            };
