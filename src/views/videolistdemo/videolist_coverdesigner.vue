    ...
    <div class="dashboard-container">
        ...
        <el-main>
            <el-table
                ...
                <el-table-column label="美工coverdesignerid+上传封面" prop="coverdesignerid" width="300" align="center">
                    <template slot-scope="scope">
                ...
                <el-table-column label="文稿标题title" prop="title" width="530" align="center">
                </el-table-column>
...
export default {
    ...
    methods: {
        ...
        querydemo() {
            let con = {
                columns:
                    "id,title,subtitle,author,iscooperation,coauthor,keyword,contentsource,theme,priority,content,creator,createtime,updmperson,updmtime,status,coverdesignerid,isdel,requirement",
            };
